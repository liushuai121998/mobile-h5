var interwords = { confirm: "确认", cancel: "取消", close: "关闭", def: "缺省", again: "请重新尝试操作！", norecord: "没有数据记录", addrecord: "请先在网站后台添加数据记录", nodata: "没有数据", specialChar: '不能含有“;/?:@=&<>"#%{}|\\^~[]`”特殊字符。', loading: "加载中...", error: "出错啦", antistop: "请输入关键词", keyword: "请输入关键字", beijing: "北京市", myriad: "万", prompt: "温馨提示：", auth: {} };
...
var getParentWindow = function() { try { return parent.zqceparentaaaa || parent } catch (e) { return window } };
...
function getHost() { var e = window.location.hostname; return sendLevel.test(e) ? e : e.startWith("www.") ? e.replace("www.", "") : e }
...
function injectScript(e, t, n, i) {
    if (void 0 === i && (i = 0), i >= t.length) n();
        ...
        r.type = "text/javascript", r.src = t[i], r.onload = r.onreadystatechange = function() { r.readyState && "loaded" != r.readyState && "complete" != r.readyState || t[i] && (t[i] = null, injectScript(e, t, n, i + 1)) }, e.getElementsByTagName("head")[0].appendChild(r)
    }
}

function isFrontEnv() { return !(null != getParentWindow().$LAB && "object" == typeof getParentWindow().$LAB) }
window.globalObj = window.globalObj || {},
    function() {
        var e, t;
        t = "", window.globalObj.getProtocol = function() { return t || (t = "//"), t }, window.globalObj.getProtocolHead = function() { return e || (e = location.protocol.substring(0, location.protocol.length - 1)), e }
    }(), String.prototype.endWith = function(e) { return !(null == e || "" == e || 0 == this.length || e.length > this.length) && this.substring(this.length - e.length) == e }, String.prototype.startWith = function(e) { return !(null == e || "" == e || 0 == this.length || e.length > this.length) && this.substr(0, e.length) == e };
var $define = function(e, t, n) { $control.isArray(e) && e.unshift("jquery"), $control.isArray(t) && t.unshift("jquery"), define(e, t, n) },
    $compCl = function() {
        var n = {},
            t = [];
        return { addComp: function(e, t) { t.init && (n[e] = t.init) }, initAll: function(e) { e({ requireJsAry: t, initFuncs: n }) }, getAllInitFunc: function() { return n }, getAllRequire: function() { return t }, getScope: function(e) { return 1 <= $("#c_" + e).length ? $("#c_" + e) : $("#comp_" + e) } }
    }(),
    $control = {
        refreshAll: function() {
            $compCl.initAll(function(e) {
                var n = e.initFuncs;
                e.requireJsAry;
                ! function() { for (var t in n) try { n[t].init() } catch (e) { window.console && window.console.log("exec-comp name:" + t) } }()
            })
        },
        refreshById: function(t) { var e, n = $compCl.getAllInitFunc()[t]; try { e = n.init } catch (e) { console.log("error function key not find" + t) } return e instanceof Function && n.init(), n },
...
! function(global) {
    ...
    function newContext(l) {
                ...
                e: for (o = (r = e.split("/")).length; 0 < o; o -= 1) {
                    if (s = r.slice(0, o).join("/"), p)
                        for (a = p.length; 0 < a; a -= 1)
                            if ((i = getOwn(m, p.slice(0, a).join("/"))) && (i = getOwn(i, s))) { c = i, u = o; break e }!d && g && getOwn(g, s) && (d = getOwn(g, s), f = o)
                }!c && d && (c = d, u = f),
        ...
        function x(t) { isBrowser && each(scripts(), function(e) { if (e.getAttribute("data-requiremodule") === t && e.getAttribute("data-requirecontext") === p.contextName) return e.parentNode.removeChild(e), !0 }) }

        function C(e) { var t = getOwn(v.paths, e); if (t && isArray(t) && 1 < t.length) return t.shift(), p.require.undef(e), p.require([e]), !0 }

        function T(e) { var t, n = e ? e.indexOf("!") : -1; return -1 < n && (t = e.substring(0, n), e = e.substring(n + 1, e.length)), [t, e] }
        ...
        function E(e, t, n, i) {
            var r, o, a, s, l = null,
                ...
                d = !0,
                f = "";
            return e || (d = !1, e = "_@r" + (y += 1)), l = (s = T(e))[0], e = s[1], l && (l = w(l, c, i), o = getOwn(m, l)), e && (l ? f = o && o.normalize ? o.normalize(e, function(e) { return w(e, c, i) }) : w(e, c, i) : (l = (s = T(f = w(e, c, i)))[0], f = s[1], n = !0, r = p.nameToUrl(f))), { prefix: l, name: f, parentMap: t, unnormalized: !!(a = !l || o || n ? "" : "_unnormalized" + (b += 1)), url: r, originalName: u, isDefine: d, id: (l ? l + "!" + f : f) + a }
        }
        ...
        function S() { globalDefQueue.length && (apsp.apply(h, [h.length, 0].concat(globalDefQueue)), globalDefQueue = []) }

        function q(e) { delete d[e], delete f[e] }
        ...
        function N() {
            ...
            if (!n) {
                ...
                }), r && !i || !s || !isBrowser && !isWebWorker || u || (u = setTimeout(function() { u = 0, N() }, 50)), n = !1
            }
        }

        function a(e) { hasProp(m, e[0]) || k(E(e[0], null, !0)).init(e[1], e[2]) }

        function o(e, t, n, i) { e.detachEvent && !isOpera ? i && e.detachEvent(i, t) : e.removeEventListener(n, t, !1) }

        function s(e) { var t = e.currentTarget || e.srcElement; return o(t, p.onScriptLoad, "load", "onreadystatechange"), o(t, p.onScriptError, "error"), { node: t, id: t && t.getAttribute("data-requiremodule") } }
        ...
        return c = { require: function(e) { return e.require ? e.require : e.require = p.makeRequire(e.map) }, exports: function(e) { if (e.usingExports = !0, e.map.isDefine) return e.exports ? m[e.map.id] = e.exports : e.exports = m[e.map.id] = {} }, module: function(e) { return e.module ? e.module : e.module = { id: e.map.id, uri: e.map.url, config: function() { return getOwn(v.config, e.map.id) || {} }, exports: e.exports || (e.exports = {}) } } }, (e = function(e) { this.events = getOwn(i, e.id) || {}, this.map = e, this.shim = getOwn(v.shim, e.id), this.depExports = [], this.depMaps = [], this.depMatched = [], this.pluginMaps = {}, this.depCount = 0 }).prototype = {
            ...
            fetch: function() {
                if (!this.fetched) {
                    ...
                    p.makeRequire(this.map, { enableBuildCallback: !0 })(this.shim.deps || [], bind(this, function() { return e.prefix ? this.callPlugin() : this.load() }))
                }
            },
            load: function() {
                var e = this.map.url;
            ...
            callPlugin: function() {
                ...
                this.depMaps.push(e), _(e, "defined", bind(this, function(e) {
                    ...
                    return this.map.unnormalized ? (e.normalize && (r = e.normalize(r, function(e) { return w(e, a, !0) }) || ""), _(t = E(l.prefix + "!" + r, this.map.parentMap), "defined", bind(this, function(e) { this.init([], function() { return e }, null, { enabled: !0, ignore: !0 }) })), void((n = getOwn(d, t.id)) && (this.depMaps.push(t), this.events.error && n.on("error", bind(this, function(e) { this.emit("error", e) })), n.enable()))) : i ? (this.map.url = p.nameToUrl(i), void this.load()) : ((o = bind(this, function(e) { this.init([], function() { return e }, null, { enabled: !0 }) })).error = bind(this, function(e) { this.inited = !0, (this.error = e).requireModules = [c], eachProp(d, function(e) { 0 === e.map.id.indexOf(c + "_unnormalized") && q(e.map.id) }), j(e) }), o.fromText = bind(this, function(e, t) {
                        var n = l.name,
                            i = E(n),
                            r = useInteractive;
                        t && (e = t), r && (useInteractive = !1), k(i), hasProp(v.config, c) && (v.config[n] = v.config[c]);
                        try { req.exec(e) } catch (e) { return j(makeError("fromtexteval", "fromText eval for " + c + " failed: " + e, e, [c])) }
            ...
            enable: function() {
                (f[this.map.id] = this).enabled = !0, this.enabling = !0, each(this.depMaps, bind(this, function(e, t) {
                    ...
                    if ("string" == typeof e) {
                        ...
                        this.depCount += 1, _(e, "defined", bind(this, function(e) { this.defineDep(t, e), this.check() })), this.errback && _(e, "error", bind(this, this.errback))
                    }
            ...
            configure: function(e) {
                ...
                eachProp(e, function(e, t) { i[t] ? (v[t] || (v[t] = {}), mixin(v[t], e, !0, !0)) : v[t] = e }), e.bundles && eachProp(e.bundles, function(e, t) { each(e, function(e) { e !== t && (g[e] = t) }) }), e.shim && (eachProp(e.shim, function(e, t) { isArray(e) && (e = { deps: e }), !e.exports && !e.init || e.exportsFn || (e.exportsFn = p.makeShimExports(e)), n[t] = e }), v.shim = n), e.packages && each(e.packages, function(e) {
                    var t;
                ...
                }), eachProp(d, function(e, t) { e.inited || e.map.unnormalized || (e.map = E(t)) }), (e.deps || e.callback) && p.require(e.deps || [], e.callback)
            },
            ...
            makeRequire: function(o, a) {
                function s(e, t, n) { var i, r; return a.enableBuildCallback && t && isFunction(t) && (t.__requireJsBuild = !0), "string" == typeof e ? isFunction(t) ? j(makeError("requireargs", "Invalid require call"), n) : o && hasProp(c, e) ? c[e](d[o.id]) : req.get ? req.get(p, e, o, s) : (i = E(e, o, !1, !0).id, hasProp(m, i) ? m[i] : j(makeError("notloaded", 'Module name "' + i + '" has not been loaded yet for context: ' + l + (o ? "" : ". Use require([])")))) : (A(), p.nextTick(function() { A(), (r = k(E(null, o))).skipMap = a.skipMap, r.init(e, t, n, { enabled: !0 }), N() }), s) }
                return a = a || {}, mixin(s, {
                    isBrowser: isBrowser,
                    toUrl: function(e) {
                    ...
                    defined: function(e) { return hasProp(m, E(e, o, !1, !0).id) },
                    specified: function(e) { return e = E(e, o, !1, !0).id, hasProp(m, e) || hasProp(d, e) }
                }), o || (s.undef = function(n) {
                    S();
                    var e = E(n, o, !0),
                        t = getOwn(d, n);
                    x(n), delete m[n], delete r[e.url], delete i[n], eachReverse(h, function(e, t) { e[0] === n && h.splice(t, 1) }), t && (t.events.defined && (i[n] = t.events), q(n))
                }), s
            },
            enable: function(e) { getOwn(d, e.id) && k(e).enable() },
            ...
            onScriptError: function(e) { var t = s(e); if (!C(t.id)) return j(makeError("scripterror", "Script error for: " + t.id, e, [t.id])) }
...
require.config({ baseUrl: window.isStaticedDemo ? "../../public/" : window.globalObj.getProtocol() + getStaticHost() + "/mobile-h5/public/", waitSeconds: 8e3, shim: { bMap: { exports: "bMap" } }, paths: { utils: wgtlib + "utils", wgt_util: wgtCommonPath + "wgt_util", wgt_etree: wgtCommonPath + "wgt_etree", wgt_etree_cross: wgtCommonPath + "wgt_etree_cross", wgt_lazyload: wgtCommonPath + "wgt_lazyload", wgt_readyload: wgtCommonPath + "wgt_readyload", "jquery.adFocus": wgtCommonPath + "jquery.adFocus", "jquery.carouselPic": wgtCommonPath + "jquery.carouselPic", "jquery.mobileAdFocus": wgtCommonPath + "jquery.mobileAdFocus", swiper: wgtCommonPath + "swiper", velocity: wgtCommonPath + "velocity", "jquery.overEllipsis": wgtCommonPath + "jquery.overEllipsis", "jquery.easyZoom": wgtCommonPath + "jquery.easyZoom", "jquery.dialogMgr": wgtCommonPath + "jquery.dialogMgr", "jquery.formValidate": wgtCommonPath + "jquery.formValidate", ckeditor: wgtCommonPath + "ckeditor/ckeditor", "jquery.datePicker": wgtCommonPath + "DatePicker-LQ/js/jquery.datePicker", "jquery.searchList": wgtCommonPath + "jqueryFn/jquery.searchList", third_baiduMap: window.globalObj.getProtocol() + "api.map.baidu.com/getscript?v=1.4", third_baiduMap_2: window.globalObj.getProtocol() + "api.map.baidu.com/getscript?v=2.0&ak=6lNan2DV0rYwYRwqOW6rDhLHMw0KddKK&services=&t=20170912191900", bMap: window.globalObj.getProtocol() + "api.map.baidu.com/api?v=2.0&ak=6lNan2DV0rYwYRwqOW6rDhLHMw0KddKK&s=1&services=&t=20170912191900", async: wgtCommonPath + "async", "jquery.baidumap": wgtCommonPath + "jquery.baidumap", "jquery.qrcode": wgtCommonPath + "jquery.qrcode", paging: wgtCommonPath + "paging", frontPaging: wgtCommonPath + "jquery.frontPaging", "jquery.fileDownload": wgtCommonPath + "jquery.fileDownload", dotdotdot: wgtCommonPath + "jquery.dotdotdot", tmpl: wgtCommonPath + "jquery.tmpl", etreeCrossApart: wgtCommonPath + "jquery.etreeCrossApart", etreeApart: wgtCommonPath + "jquery.etreeApart", ks3jssdk: wgtCommonPath + "ks3jssdk", "jquery.region": wgtCommonPath + "jquery.region", regionJsonData: wgtCommonPath + "regionJsonData", "jquery.marquee": wgtCommonPath + "jquery.marquee", "jquery.regionNew": wgtCommonPath + "jquery.regionNew", regionJsonDataNew: "js/common/metaCountryData", foreignRegionJsonData: "js/common/foreignMetaCountryData", afterLoad: "wgt/coreLibs/afterLoad", md5: wgtCommonPath + "jquery.md5", xadFocus: wgtCommonPath + "xadFocus", xcategory: wgtCommonPath + "xcategory", "jquery.counter": wgtCommonPath + "jquery.counter", "jquery.message": wgtCommonPath + "jquery.message", "jquery.confirm": wgtCommonPath + "jquery.confirm", "jquery.mediaQuery": wgtCommonPath + "jquery.mediaQuery", "swiper4.4.2": wgtCommonPath + "swiper4.4.2", bootstrap: wgtCommonPath + "bootstrap", adFocus: "m/wgt/frontPlugin/jquery.adFocus", "jquery.share": wgtCommonPath + "iShare", audio: wgtCommonPath + "audio", clipboard: wgtCommonPath + "clipboard", "jquery.regionTreeSelect": wgtCommonPath + "jquery.regionTreeSelect", leftTime: wgtCommonPath + "leftTime", mobiscroll: "m/wgt/frontPlugin/mobiscroll", multipleSelect: wgtCommonPath + "multipleSelect/multipleSelect", laydate: wgtCommonPath + "laydate/laydate" } }), window.crosswiseMalposition = function() {
    if (!window.isCWMP && isFrontEnv()) {
        ...
        t = t.add(s), $(window).resize(function(e) { isFrontEnv() && h(t) });
        var l = 1920;
        ...
        h(t), t.filter("div[data-animation]", "div[id^='c_'],div[id^='w_']").on("FR_ANIMATED", function() {
            var e, t = $(this);
            setTimeout((e = t, function() { h(e) }), 500)
        })
    }
...
function mobileFoward(e) { window.location.href = e }

function getSettingMobileUrl() { for (var e = document.getElementsByTagName("link"), t = 0; t < e.length; t++) { var n = e[t]; if ("alternate" == n.rel) return "" == n.href ? null : n.href } return null }
...
function writeBFP() { getCookie("bfp") || setCookie("bfp", tenant.id + "_xgw_" + rand(), 360) }
if (window.addEventListener ? window.addEventListener("load", readyFun) : window.attachEvent && window.attachEvent("onload", readyFun), function(e, t) { "object" == typeof module && "object" == typeof module.exports ? module.exports = e.document ? t(e, !0) : function(e) { if (!e.document) throw new Error("jQuery requires a window with a document"); return t(e) } : t(e) }("undefined" != typeof window ? window : this, function(h, e) {
        var d = [],
            u = d.slice,
            m = d.concat,
            s = d.push,
        ...
        T.fn = T.prototype = {
            ...
            pushStack: function(e) { var t = T.merge(this.constructor(), e); return t.prevObject = this, t.context = this.context, t },
            each: function(e, t) { return T.each(this, e, t) },
            ...
            noop: function() {},
            isFunction: function(e) { return "function" === T.type(e) },
            isArray: Array.isArray || function(e) { return "array" === T.type(e) },
            isWindow: function(e) { return null != e && e == e.window },
            isNumeric: function(e) { return !T.isArray(e) && 0 <= e - parseFloat(e) },
            isEmptyObject: function(e) { var t; for (t in e) return !1; return !0 },
            isPlainObject: function(e) {
                var t;
                if (!e || "object" !== T.type(e) || e.nodeType || T.isWindow(e)) return !1;
                try { if (e.constructor && !g.call(e, "constructor") && !g.call(e.constructor.prototype, "isPrototypeOf")) return !1 } catch (e) { return !1 }
                if (v.ownLast)
                    for (t in e) return g.call(e, t);
                for (t in e);
                return void 0 === t || g.call(e, t)
            },
            type: function(e) { return null == e ? e + "" : "object" == typeof e || "function" == typeof e ? n[t.call(e)] || "object" : typeof e },
            globalEval: function(e) { e && T.trim(e) && (h.execScript || function(e) { h.eval.call(h, e) })(e) },
            camelCase: function(e) { return e.replace(o, "ms-").replace(a, l) },
            ...
            trim: function(e) { return null == e ? "" : (e + "").replace(i, "") },
            makeArray: function(e, t) { var n = t || []; return null != e && (c(Object(e)) ? T.merge(n, "string" == typeof e ? [e] : e) : s.call(n, e)), n },
            ...
            guid: 1,
            proxy: function(e, t) { var n, i, r; if ("string" == typeof t && (r = e[t], t = e, e = r), T.isFunction(e)) return n = u.call(arguments, 2), (i = function() { return e.apply(t || this, n.concat(u.call(arguments))) }).guid = e.guid = e.guid || T.guid++, i },
            now: function() { return +new Date },
            support: v
        }), T.each("Boolean Number String Function Array Date RegExp Object Error".split(" "), function(e, t) { n["[object " + t + "]"] = t.toLowerCase() });
        var f = function(n) {
            var e, h, w, o, i, m, d, g, x, c, u, v, C, r, y, b, a, s, T, E = "sizzle" + -new Date,
                ...
                p = re(),
                j = re(),
                S = function(e, t) { return e === t && (u = !0), 0 },
                q = "undefined",
                N = {}.hasOwnProperty,
                t = [],
                A = t.pop,
                ...
                X = new RegExp(B),
                G = new RegExp("^" + F + "$"),
                V = { ID: new RegExp("^#(" + H + ")"), CLASS: new RegExp("^\\.(" + H + ")"), TAG: new RegExp("^(" + H.replace("w", "w*") + ")"), ATTR: new RegExp("^" + R), PSEUDO: new RegExp("^" + B), CHILD: new RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\(" + M + "*(even|odd|(([+-]|)(\\d*)n|)" + M + "*(?:([+-]|)" + M + "*(\\d+)|))" + M + "*\\)|)", "i"), bool: new RegExp("^(?:" + O + ")$", "i"), needsContext: new RegExp("^" + M + "*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(" + M + "*((?:-\\d)?\\d*)" + M + "*\\)|)(?=[^-]|$)", "i") },
            ...
            try { D.apply(t = P.call(k.childNodes), k.childNodes), t[k.childNodes.length].nodeType } catch (e) {
                D = {
                    apply: t.length ? function(e, t) { $.apply(e, P.call(t)) } : function(e, t) {
            ...
            function ie(e, t, n, i) {
                ...
                if (y && !i) {
                    if (r = K.exec(e))
                        if (a = r[1]) { if (9 === s) { if (!(o = t.getElementById(a)) || !o.parentNode) return n; if (o.id === a) return n.push(o), n } else if (t.ownerDocument && (o = t.ownerDocument.getElementById(a)) && T(t, o) && o.id === a) return n.push(o), n } else { if (r[2]) return D.apply(n, t.getElementsByTagName(e)), n; if ((a = r[3]) && h.getElementsByClassName && t.getElementsByClassName) return D.apply(n, t.getElementsByClassName(a)), n }
                    if (h.qsa && (!b || !b.test(e))) {
                        ...
                        if (p) try { return D.apply(n, f.querySelectorAll(p)), n } catch (e) {} finally { u || t.removeAttribute("id") }
                    }
                }
                return g(e.replace(W, "$1"), t, n, i)
            }

            function re() { var i = []; return function e(t, n) { return i.push(t + " ") > w.cacheLength && delete e[i.shift()], e[t + " "] = n } }

            function oe(e) { return e[E] = !0, e }

            function ae(e) { var t = C.createElement("div"); try { return !!e(t) } catch (e) { return !1 } finally { t.parentNode && t.parentNode.removeChild(t), t = null } }

            function se(e, t) { for (var n = e.split("|"), i = e.length; i--;) w.attrHandle[n[i]] = t }
            ...
            function ue(n) { return function(e) { var t = e.nodeName.toLowerCase(); return ("input" === t || "button" === t) && e.type === n } }

            function de(a) { return oe(function(o) { return o = +o, oe(function(e, t) { for (var n, i = a([], e.length, o), r = i.length; r--;) e[n = i[r]] && (e[n] = !(t[n] = e[n])) }) }) }

            function fe(e) { return e && typeof e.getElementsByTagName !== q && e }
            for (e in h = ie.support = {}, i = ie.isXML = function(e) { var t = e && (e.ownerDocument || e).documentElement; return !!t && "HTML" !== t.nodeName }, v = ie.setDocument = function(e) {
                    var t, l = e ? e.ownerDocument || e : k,
                        n = l.defaultView;
                    return l !== C && 9 === l.nodeType && l.documentElement ? (r = (C = l).documentElement, y = !i(l), n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", function() { v() }, !1) : n.attachEvent && n.attachEvent("onunload", function() { v() })), h.attributes = ae(function(e) { return e.className = "i", !e.getAttribute("className") }), h.getElementsByTagName = ae(function(e) { return e.appendChild(l.createComment("")), !e.getElementsByTagName("*").length }), h.getElementsByClassName = Y.test(l.getElementsByClassName) && ae(function(e) { return e.innerHTML = "<div class='a'></div><div class='a i'></div>", e.firstChild.className = "i", 2 === e.getElementsByClassName("i").length }), h.getById = ae(function(e) { return r.appendChild(e).id = E, !l.getElementsByName || !l.getElementsByName(E).length }), h.getById ? (w.find.ID = function(e, t) { if (typeof t.getElementById !== q && y) { var n = t.getElementById(e); return n && n.parentNode ? [n] : [] } }, w.filter.ID = function(e) { var t = e.replace(te, ne); return function(e) { return e.getAttribute("id") === t } }) : (delete w.find.ID, w.filter.ID = function(e) { var n = e.replace(te, ne); return function(e) { var t = typeof e.getAttributeNode !== q && e.getAttributeNode("id"); return t && t.value === n } }), w.find.TAG = h.getElementsByTagName ? function(e, t) { if (typeof t.getElementsByTagName !== q) return t.getElementsByTagName(e) } : function(e, t) {
                        var n, i = [],
                            r = 0,
                        ...
                        return i
                    }, w.find.CLASS = h.getElementsByClassName && function(e, t) { if (typeof t.getElementsByClassName !== q && y) return t.getElementsByClassName(e) }, a = [], b = [], (h.qsa = Y.test(l.querySelectorAll)) && (ae(function(e) { e.innerHTML = "<select msallowclip=''><option selected=''></option></select>", e.querySelectorAll("[msallowclip^='']").length && b.push("[*^$]=" + M + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || b.push("\\[" + M + "*(?:value|" + O + ")"), e.querySelectorAll(":checked").length || b.push(":checked") }), ae(function(e) {
                    ...
                    if ((e.ownerDocument || e) !== C && v(e), t = t.replace(U, "='$1']"), h.matchesSelector && y && (!a || !a.test(t)) && (!b || !b.test(t))) try { var n = s.call(e, t); if (n || h.disconnectedMatch || e.document && 11 !== e.document.nodeType) return n } catch (e) {}
                    return 0 < ie(t, C, null, [e]).length
                }, ie.contains = function(e, t) { return (e.ownerDocument || e) !== C && v(e), T(e, t) }, ie.attr = function(e, t) {
                    ...
                    var t, n = [],
                        i = 0,
                        r = 0;
                    if (u = !h.detectDuplicates, c = !h.sortStable && e.slice(0), e.sort(S), u) { for (; t = e[r++];) t === e[r] && (i = n.push(r)); for (; i--;) e.splice(n[i], 1) }
                    return c = null, e
                    ...
                    preFilter: { ATTR: function(e) { return e[1] = e[1].replace(te, ne), e[3] = (e[3] || e[4] || e[5] || "").replace(te, ne), "~=" === e[2] && (e[3] = " " + e[3] + " "), e.slice(0, 4) }, CHILD: function(e) { return e[1] = e[1].toLowerCase(), "nth" === e[1].slice(0, 3) ? (e[3] || ie.error(e[0]), e[4] = +(e[4] ? e[5] + (e[6] || 1) : 2 * ("even" === e[3] || "odd" === e[3])), e[5] = +(e[7] + e[8] || "odd" === e[3])) : e[3] && ie.error(e[0]), e }, PSEUDO: function(e) { var t, n = !e[6] && e[2]; return V.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && X.test(n) && (t = m(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(0, 3)) } },
                    filter: {
                        TAG: function(e) { var t = e.replace(te, ne).toLowerCase(); return "*" === e ? function() { return !0 } : function(e) { return e.nodeName && e.nodeName.toLowerCase() === t } },
                        CLASS: function(e) { var t = l[e + " "]; return t || (t = new RegExp("(^|" + M + ")" + e + "(" + M + "|$)")) && l(e, function(e) { return t.test("string" == typeof e.className && e.className || typeof e.getAttribute !== q && e.getAttribute("class") || "") }) },
                        ATTR: function(n, i, r) { return function(e) { var t = ie.attr(e, n); return null == t ? "!=" === i : !i || (t += "", "=" === i ? t === r : "!=" === i ? t !== r : "^=" === i ? r && 0 === t.indexOf(r) : "*=" === i ? r && -1 < t.indexOf(r) : "$=" === i ? r && t.slice(-r.length) === r : "~=" === i ? -1 < (" " + t + " ").indexOf(r) : "|=" === i && (t === r || t.slice(0, r.length + 1) === r + "-")) } },
                        CHILD: function(p, e, t, h, m) {
                            var g = "nth" !== p.slice(0, 3),
                                v = "last" !== p.slice(-4),
                                y = "of-type" === e;
                            return 1 === h && 0 === m ? function(e) { return !!e.parentNode } : function(e, t, n) {
                                ...
                                if (u) {
                                    ...
                                    if (l = [v ? u.firstChild : u.lastChild], v && f) {
                                        for (s = (i = (r = u[E] || (u[E] = {}))[p] || [])[0] === _ && i[1], a = i[0] === _ && i[2], o = s && u.childNodes[s]; o = ++s && o && o[c] || (a = s = 0) || l.pop();)
                                            if (1 === o.nodeType && ++a && o === e) { r[p] = [_, s, a]; break }
                        ...
                        PSEUDO: function(e, o) { var t, a = w.pseudos[e] || w.setFilters[e.toLowerCase()] || ie.error("unsupported pseudo: " + e); return a[E] ? a(o) : 1 < a.length ? (t = [e, e, "", o], w.setFilters.hasOwnProperty(e.toLowerCase()) ? oe(function(e, t) { for (var n, i = a(e, o), r = i.length; r--;) e[n = L.call(e, i[r])] = !(t[n] = i[r]) }) : function(e) { return a(e, 0, t) }) : a }
                    },
                    pseudos: {
                        not: oe(function(e) {
                            var i = [],
                                r = [],
                                s = d(e.replace(W, "$1"));
                            return s[E] ? oe(function(e, t, n, i) { for (var r, o = s(e, null, i, []), a = e.length; a--;)(r = o[a]) && (e[a] = !(t[a] = r)) }) : function(e, t, n) { return i[0] = e, s(i, null, n, r), !r.pop() }
                        }),
                        has: oe(function(t) { return function(e) { return 0 < ie(t, e).length } }),
                        contains: oe(function(t) { return function(e) { return -1 < (e.textContent || e.innerText || o(e)).indexOf(t) } }),
                        lang: oe(function(n) {
                        ...
                        lt: de(function(e, t, n) { for (var i = n < 0 ? n + t : n; 0 <= --i;) e.push(i); return e }),
            ...
            function me(a, e, t) {
                ...
                return e.first ? function(e, t, n) {
                    ...
                    if (n) {
                        ...
                        for (; e = e[s];)
                            if (1 === e.nodeType || l) { if ((i = (r = e[E] || (e[E] = {}))[s]) && i[0] === _ && i[1] === c) return o[2] = i[2]; if ((r[s] = o)[2] = a(e, t, n)) return !0 }
                }
            }
            ...
            function ve(e, t, n, i, r) { for (var o, a = [], s = 0, l = e.length, c = null != t; s < l; s++)(o = e[s]) && (n && !n(o, i, r) || (a.push(o), c && t.push(s))); return a }
            ...
            function ye(p, h, m, g, v, e) {
                return g && !g[E] && (g = ye(g)), v && !v[E] && (v = ye(v, e)), oe(function(e, t, n, i) {
                    var r, o, a, s = [],
                        l = [],
                        c = t.length,
                        u = e || function(e, t, n) { for (var i = 0, r = t.length; i < r; i++) ie(e, t[i], n); return n }(h || "*", n.nodeType ? [n] : n, []),
            ...
            function be(e) {
                for (var i, t, n, r = e.length, o = w.relative[e[0].type], a = o || w.relative[" "], s = o ? 1 : 0, l = me(function(e) { return e === i }, a, !0), c = me(function(e) { return -1 < L.call(i, e) }, a, !0), u = [function(e, t, n) { return !o && (n || t !== x) || ((i = t).nodeType ? l(e, t, n) : c(e, t, n)) }]; s < r; s++)
                    if (t = w.relative[e[s].type]) u = [me(ge(u), t)];
                    else {
                        if ((t = w.filter[e[s].type].apply(null, e[s].matches))[E]) { for (n = ++s; n < r && !w.relative[e[n].type]; n++); return ye(1 < s && ge(u), 1 < s && he(e.slice(0, s - 1).concat({ value: " " === e[s - 2].type ? "*" : "" })).replace(W, "$1"), t, s < n && be(e.slice(s, n)), n < r && be(e = e.slice(n)), n < r && he(e)) }
                        u.push(t)
                    }
                return ge(u)
            }
            return pe.prototype = w.filters = w.pseudos, w.setFilters = new pe, m = ie.tokenize = function(e, t) { var n, i, r, o, a, s, l, c = p[e + " "]; if (c) return t ? 0 : c.slice(0); for (a = e, s = [], l = w.preFilter; a;) { for (o in n && !(i = I.exec(a)) || (i && (a = a.slice(i[0].length) || a), s.push(r = [])), n = !1, (i = z.exec(a)) && (n = i.shift(), r.push({ value: n, type: i[0].replace(W, " ") }), a = a.slice(n.length)), w.filter) !(i = V[o].exec(a)) || l[o] && !(i = l[o](i)) || (n = i.shift(), r.push({ value: n, type: o, matches: i }), a = a.slice(n.length)); if (!n) break } return t ? a.length : a ? ie.error(e) : p(e, s).slice(0) }, d = ie.compile = function(e, t) {
                var n, g, v, y, b, i, r = [],
                    o = [],
                    a = j[e + " "];
                if (!a) {
        ...
        function w(e, n, i) {
            if (T.isFunction(n)) return T.grep(e, function(e, t) { return !!n.call(e, t, e) !== i });
            if (n.nodeType) return T.grep(e, function(e) { return e === n !== i });
            if ("string" == typeof n) {
                if (b.test(n)) return T.filter(n, e, i);
                n = T.filter(n, e)
            }
            return T.grep(e, function(e) { return 0 <= T.inArray(e, n) !== i })
        }
        T.filter = function(e, t, n) { var i = t[0]; return n && (e = ":not(" + e + ")"), 1 === t.length && 1 === i.nodeType ? T.find.matchesSelector(i, e) ? [i] : [] : T.find.matches(e, T.grep(t, function(e) { return 1 === e.nodeType })) }, T.fn.extend({
            ...
            filter: function(e) { return this.pushStack(w(this, e || [], !1)) },
            not: function(e) { return this.pushStack(w(this, e || [], !0)) },
            is: function(e) { return !!w(this, "string" == typeof e && p.test(e) ? T(e) : e || [], !1).length }
        });
        var x, C = h.document,
            E = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;
        ...
        T.extend({ dir: function(e, t, n) { for (var i = [], r = e[t]; r && 9 !== r.nodeType && (void 0 === n || 1 !== r.nodeType || !T(r).is(n));) 1 === r.nodeType && i.push(r), r = r[t]; return i }, sibling: function(e, t) { for (var n = []; e; e = e.nextSibling) 1 === e.nodeType && e !== t && n.push(e); return n } }), T.fn.extend({
            has: function(e) {
                var t, n = T(e, this),
                    i = n.length;
        ...
        T.Callbacks = function(r) {
            ...
            Deferred: function(e) {
                ...
                return a.pipe = a.then, T.each(o, function(e, t) {
                    var n = t[2],
                        i = t[3];
                    a[t[1]] = n.add, i && n.add(function() { r = i }, o[1 ^ e][2].disable, o[2][2].lock), s[t[0]] = function() { return s[t[0] + "With"](this === s ? a : this, arguments), this }, s[t[0] + "With"] = n.fireWith
            ...
            when: function(e) {
                var r, t, n, i = 0,
                    ...
                    l = 1 === s ? e : T.Deferred(),
                    c = function(t, n, i) { return function(e) { n[t] = this, i[t] = 1 < arguments.length ? u.call(arguments) : e, i === r ? l.notifyWith(n, i) : --s || l.resolveWith(n, i) } };
                if (1 < a)
        ...
        }), T.fn.ready = function(e) { return T.ready.promise().done(e), this }, T.extend({
            isReady: !1,
            readyWait: 1,
            ...
            if (!S)
                ...
                var n = !1;
                try { n = null == h.frameElement && C.documentElement } catch (e) {}
                n && n.doScroll && function t() {
                    if (!T.isReady) {
                        try { n.doScroll("left") } catch (e) { return setTimeout(t, 50) }
                        A(), T.ready()
                    }
                }()
            }
        ...
        v.ownLast = "0" !== D, v.inlineBlockNeedsLayout = !1, T(function() {
            ...
            function() {
                ...
                if (null == v.deleteExpando) { v.deleteExpando = !0; try { delete e.test } catch (e) { v.deleteExpando = !1 } }
                e = null
        ...
        function M(e, t, n) {
            if (void 0 === n && 1 === e.nodeType) {
                ...
                if ("string" == typeof(n = e.getAttribute(i))) {
                    try { n = "true" === n || "false" !== n && ("null" === n ? null : +n + "" === n ? +n : L.test(n) ? T.parseJSON(n) : n) } catch (e) {}
                    T.data(e, t, n)
                } else n = void 0
            }
            return n
        ...
        function R(e, t, n) {
            if (T.acceptData(e)) {
                ...
                if (a[s]) { if (t && (i = n ? a[s] : a[s].data)) { r = (t = T.isArray(t) ? t.concat(T.map(t, T.camelCase)) : t in i ? [t] : (t = T.camelCase(t)) in i ? [t] : t.split(" ")).length; for (; r--;) delete i[t[r]]; if (n ? !H(i) : !T.isEmptyObject(i)) return }(n || (delete a[s].data, H(a[s]))) && (o ? T.cleanData([e], !0) : v.deleteExpando || a != a.window ? delete a[s] : a[s] = null) }
            }
        }
        T.extend({ cache: {}, noData: { "applet ": !0, "embed ": !0, "object ": "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" }, hasData: function(e) { return !!(e = e.nodeType ? T.cache[e[T.expando]] : e[T.expando]) && !H(e) }, data: function(e, t, n) { return F(e, t, n) }, removeData: function(e, t) { return R(e, t) }, _data: function(e, t, n) { return F(e, t, n, !0) }, _removeData: function(e, t) { return R(e, t, !0) } }), T.fn.extend({
            data: function(e, t) {
                var n, i, r, o = this[0],
                    a = o && o.attributes;
                if (void 0 !== e) return "object" == typeof e ? this.each(function() { T.data(this, e) }) : 1 < arguments.length ? this.each(function() { T.data(this, e, t) }) : o ? M(o, e, T.data(o, e)) : void 0;
            ...
            removeData: function(e) { return this.each(function() { T.removeData(this, e) }) }
        }), T.extend({
            queue: function(e, t, n) { var i; if (e) return t = (t || "fx") + "queue", i = T._data(e, t), n && (!i || T.isArray(n) ? i = T._data(e, t, T.makeArray(n)) : i.push(n)), i || [] },
            ...
            _queueHooks: function(e, t) { var n = t + "queueHooks"; return T._data(e, n) || T._data(e, n, { empty: T.Callbacks("once memory").add(function() { T._removeData(e, t + "queue"), T._removeData(e, n) }) }) }
        }), T.fn.extend({
            queue: function(t, n) {
                var e = 2;
        ...
        var B = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
            ...
            I = function(e, t) { return e = t || e, "none" === T.css(e, "display") || !T.contains(e.ownerDocument, e) },
            z = T.access = function(e, t, n, i, r, o, a) {
                ...
                else if (void 0 !== i && (r = !0, T.isFunction(i) || (a = !0), c && (t = a ? (t.call(e, i), null) : (c = t, function(e, t, n) { return c.call(T(e), n) })), t))
        ...
        function Z() { try { return C.activeElement } catch (e) {} }
        ...
        T.event = {
            ...
            add: function(e, t, n, i, r) {
                ...
                if (g) {
                    for (n.handler && (n = (l = n).handler, r = l.selector), n.guid || (n.guid = T.guid++), (a = g.events) || (a = g.events = {}), (u = g.handle) || ((u = g.handle = function(e) { return typeof T === P || e && T.event.triggered === e.type ? void 0 : T.event.dispatch.apply(u.elem, arguments) }).elem = e), s = (t = (t || "").match(q) || [""]).length; s--;) p = m = (o = Q.exec(t[s]) || [])[1], h = (o[2] || "").split(".").sort(), p && (c = T.event.special[p] || {}, p = (r ? c.delegateType : c.bindType) || p, c = T.event.special[p] || {}, d = T.extend({ type: p, origType: m, data: i, handler: n, guid: n.guid, selector: r, needsContext: r && T.expr.match.needsContext.test(r), namespace: h.join(".") }, l), (f = a[p]) || ((f = a[p] = []).delegateCount = 0, c.setup && !1 !== c.setup.call(e, i, h, u) || (e.addEventListener ? e.addEventListener(p, u, !1) : e.attachEvent && e.attachEvent("on" + p, u))), c.add && (c.add.call(e, d), d.handler.guid || (d.handler.guid = n.guid)), r ? f.splice(f.delegateCount++, 0, d) : f.push(d), T.event.global[p] = !0);
                    e = null
                }
            },
            ...
            special: { load: { noBubble: !0 }, focus: { trigger: function() { if (this !== Z() && this.focus) try { return this.focus(), !1 } catch (e) {} }, delegateType: "focusin" }, blur: { trigger: function() { if (this === Z() && this.blur) return this.blur(), !1 }, delegateType: "focusout" }, click: { trigger: function() { if (T.nodeName(this, "input") && "checkbox" === this.type && this.click) return this.click(), !1 }, _default: function(e) { return T.nodeName(e.target, "a") } }, beforeunload: { postDispatch: function(e) { void 0 !== e.result && e.originalEvent && (e.originalEvent.returnValue = e.result) } } },
        ...
        }, T.removeEvent = C.removeEventListener ? function(e, t, n) { e.removeEventListener && e.removeEventListener(t, n, !1) } : function(e, t, n) {
            var i = "on" + t;
            ...
            setup: function() {
                ...
                T.event.add(this, "click._submit keypress._submit", function(e) {
                    ...
                    n && !T._data(n, "submitBubbles") && (T.event.add(n, "submit._submit", function(e) { e._submit_bubble = !0 }), T._data(n, "submitBubbles", !0))
                })
            },
            postDispatch: function(e) { e._submit_bubble && (delete e._submit_bubble, this.parentNode && !e.isTrigger && T.event.simulate("submit", this.parentNode, e, !0)) },
            teardown: function() {
                if (T.nodeName(this, "form")) return !1;
            ...
            setup: function() {
                if (X.test(this.nodeName)) return "checkbox" !== this.type && "radio" !== this.type || (T.event.add(this, "propertychange._change", function(e) { "checked" === e.originalEvent.propertyName && (this._just_changed = !0) }), T.event.add(this, "click._change", function(e) { this._just_changed && !e.isTrigger && (this._just_changed = !1), T.event.simulate("change", this, e, !0) })), !1;
                T.event.add(this, "beforeactivate._change", function(e) {
                    var t = e.target;
                    X.test(t.nodeName) && !T._data(t, "changeBubbles") && (T.event.add(t, "change._change", function(e) {!this.parentNode || e.isSimulated || e.isTrigger || T.event.simulate("change", this.parentNode, e, !0) }), T._data(t, "changeBubbles", !0))
                })
            },
            ...
            teardown: function() { return T.event.remove(this, "._change"), !X.test(this.nodeName) }
        }), v.focusinBubbles || T.each({ focus: "focusin", blur: "focusout" }, function(n, i) {
            var r = function(e) { T.event.simulate(i, e.target, T.event.fix(e), !0) };
            T.event.special[i] = {
                setup: function() {
            ...
            on: function(e, t, n, i, r) {
                ...
                return 1 === r && (a = i, (i = function(e) { return T().off(e), a.apply(this, arguments) }).guid = a.guid || (a.guid = T.guid++)), this.each(function() { T.event.add(this, e, i, n, t) })
            },
            one: function(e, t, n, i) { return this.on(e, t, n, i, 1) },
            off: function(e, t, n) { var i, r; if (e && e.preventDefault && e.handleObj) return i = e.handleObj, T(e.delegateTarget).off(i.namespace ? i.origType + "." + i.namespace : i.origType, i.selector, i.handler), this; if ("object" != typeof e) return !1 !== t && "function" != typeof t || (n = t, t = void 0), !1 === n && (n = K), this.each(function() { T.event.remove(this, e, n, t) }); for (r in e) this.off(r, t, e[r]); return this },
            trigger: function(e, t) { return this.each(function() { T.event.trigger(e, t, this) }) },
            triggerHandler: function(e, t) { var n = this[0]; if (n) return T.event.trigger(e, t, n, !0) }
        });
        var te = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
            ...
            fe = /^true\/(.*)/,
            pe = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,
            he = { option: [1, "<select multiple='multiple'>", "</select>"], legend: [1, "<fieldset>", "</fieldset>"], area: [1, "<map>", "</map>"], param: [1, "<object>", "</object>"], thead: [1, "<table>", "</table>"], tr: [2, "<table><tbody>", "</tbody></table>"], col: [2, "<table><tbody></tbody><colgroup>", "</colgroup></table>"], td: [3, "<table><tbody><tr>", "</tr></tbody></table>"], _default: v.htmlSerialize ? [0, "", ""] : [1, "X<div>", "</div>"] },
        ...
        function ve(e) { U.test(e.type) && (e.defaultChecked = e.checked) }

        function ye(e, t) { return T.nodeName(e, "table") && T.nodeName(11 !== t.nodeType ? t : t.firstChild, "tr") ? e.getElementsByTagName("tbody")[0] || e.appendChild(e.ownerDocument.createElement("tbody")) : e }

        function be(e) { return e.type = (null !== T.find.attr(e, "type")) + "/" + e.type, e }

        function we(e) { var t = fe.exec(e.type); return t ? e.type = t[1] : e.removeAttribute("type"), e }

        function xe(e, t) { for (var n, i = 0; null != (n = e[i]); i++) T._data(n, "globalEval", !t || T._data(t[i], "globalEval")) }
        ...
        he.optgroup = he.option, he.tbody = he.tfoot = he.colgroup = he.caption = he.thead, he.th = he.td, T.extend({
            ...
            text: function(e) { return z(this, function(e) { return void 0 === e ? T.text(this) : this.empty().append((this[0] && this[0].ownerDocument || C).createTextNode(e)) }, null, e, arguments.length) },
            append: function() { return this.domManip(arguments, function(e) { 1 !== this.nodeType && 11 !== this.nodeType && 9 !== this.nodeType || ye(this, e).appendChild(e) }) },
            prepend: function() {
            ...
            remove: function(e, t) { for (var n, i = e ? T.filter(e, this) : this, r = 0; null != (n = i[r]); r++) t || 1 !== n.nodeType || T.cleanData(ge(n)), n.parentNode && (t && T.contains(n.ownerDocument, n) && xe(ge(n, "script")), n.parentNode.removeChild(n)); return this },
            empty: function() {
            ...
            replaceWith: function() { var t = arguments[0]; return this.domManip(arguments, function(e) { t = this.parentNode, T.cleanData(ge(this)), t && t.replaceChild(e, this) }), t && (t.length || t.nodeType) ? this : this.remove() },
        ...
        }), T.each({ appendTo: "append", prependTo: "prepend", insertBefore: "before", insertAfter: "after", replaceAll: "replaceWith" }, function(e, a) { T.fn[e] = function(e) { for (var t, n = 0, i = [], r = T(e), o = r.length - 1; n <= o; n++) t = n === o ? this : this.clone(!0), T(r[n])[a](t), s.apply(i, t.get()); return this.pushStack(i) } });
        var Ee, ke, _e = {};
        ...
        v.shrinkWrapBlocks = function() { return null != ke ? ke : (ke = !1, (t = C.getElementsByTagName("body")[0]) && t.style ? (e = C.createElement("div"), (n = C.createElement("div")).style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", t.appendChild(n).appendChild(e), typeof e.style.zoom !== P && (e.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:1px;width:1px;zoom:1", e.appendChild(C.createElement("div")).style.width = "5px", ke = 3 !== e.offsetWidth), t.removeChild(n), ke) : void 0); var e, t, n };
        var qe, Ne, Ae = /^margin/,
        ...
        function ze(e, t) { for (var n, i, r, o = [], a = 0, s = e.length; a < s; a++)(i = e[a]).style && (o[a] = T._data(i, "olddisplay"), n = i.style.display, t ? (o[a] || "none" !== n || (i.style.display = ""), "" === i.style.display && I(i) && (o[a] = T._data(i, "olddisplay", Se(i.nodeName)))) : (r = I(i), (n && "none" !== n || !r) && T._data(i, "olddisplay", r ? n : T.css(i, "display")))); for (a = 0; a < s; a++)(i = e[a]).style && (t && "none" !== i.style.display && "" !== i.style.display || (i.style.display = t ? o[a] || "" : "none")); return e }

        function Ue(e, t, n) { var i = He.exec(t); return i ? Math.max(0, i[1] - (n || 0)) + (i[2] || "px") : t }

        function Xe(e, t, n, i, r) { for (var o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; o < 4; o += 2) "margin" === n && (a += T.css(e, n + W[o], !0, r)), i ? ("content" === n && (a -= T.css(e, "padding" + W[o], !0, r)), "margin" !== n && (a -= T.css(e, "border" + W[o] + "Width", !0, r))) : (a += T.css(e, "padding" + W[o], !0, r), "padding" !== n && (a += T.css(e, "border" + W[o] + "Width", !0, r))); return a }
        ...
        function Ve(e, t, n, i, r) { return new Ve.prototype.init(e, t, n, i, r) }
        T.extend({
            cssHooks: { opacity: { get: function(e, t) { if (t) { var n = Ne(e, "opacity"); return "" === n ? "1" : n } } } },
            ...
            style: function(e, t, n, i) {
                if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                    ...
                    if ("string" === (o = typeof n) && (r = Fe.exec(n)) && (n = (r[1] + 1) * r[2] + parseFloat(T.css(e, t)), o = "number"), null != n && n == n && ("number" !== o || T.cssNumber[s] || (n += "px"), v.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), !(a && "set" in a && void 0 === (n = a.set(e, n, i))))) try { l[t] = n } catch (e) {}
                }
            },
            css: function(e, t, n, i) { var r, o, a, s = T.camelCase(t); return t = T.cssProps[s] || (T.cssProps[s] = Ie(e.style, s)), (a = T.cssHooks[t] || T.cssHooks[s]) && "get" in a && (o = a.get(e, !0, n)), void 0 === o && (o = Ne(e, t, i)), "normal" === o && t in Be && (o = Be[t]), "" === n || n ? (r = parseFloat(o), !0 === n || T.isNumeric(r) ? r || 0 : o) : o }
        }), T.each(["height", "width"], function(e, r) { T.cssHooks[r] = { get: function(e, t, n) { if (t) return Me.test(T.css(e, "display")) && 0 === e.offsetWidth ? T.swap(e, Re, function() { return Ge(e, r, n) }) : Ge(e, r, n) }, set: function(e, t, n) { var i = n && qe(e); return Ue(0, t, n ? Xe(e, r, n, v.boxSizing && "border-box" === T.css(e, "boxSizing", !1, i), i) : 0) } } }), v.opacity || (T.cssHooks.opacity = {
            get: function(e, t) { return Oe.test((t && e.currentStyle ? e.currentStyle.filter : e.style.filter) || "") ? .01 * parseFloat(RegExp.$1) + "" : t ? "1" : "" },
            set: function(e, t) {
                var n = e.style,
                    i = e.currentStyle,
        ...
        var Je, Qe, Ye, Ke, Ze, et, tt, nt = /^(?:toggle|show|hide)$/,
            ...
            ot = [function(t, e, n) {
                var i, r, o, a, s, l, c, u = this,
                    ...
                    p = t.nodeType && I(t),
                    h = T._data(t, "fxshow");
                n.queue || (null == (s = T._queueHooks(t, "fx")).unqueued && (s.unqueued = 0, l = s.empty.fire, s.empty.fire = function() { s.unqueued || l() }), s.unqueued++, u.always(function() { u.always(function() { s.unqueued--, T.queue(t, "fx").length || s.empty.fire() }) }));
                ...
                n.overflow && (f.overflow = "hidden", v.shrinkWrapBlocks() || u.always(function() { f.overflow = n.overflow[0], f.overflowX = n.overflow[1], f.overflowY = n.overflow[2] }));
                for (i in e)
                    if (r = e[i], nt.exec(r)) {
                ...
                if (T.isEmptyObject(d)) "inline" === ("none" === c ? Se(t.nodeName) : c) && (f.display = c);
                    ...
                    for (i in h ? "hidden" in h && (p = h.hidden) : h = T._data(t, "fxshow", {}), o && (h.hidden = !p), p ? T(t).show() : u.done(function() { T(t).hide() }), u.done(function() { var e; for (e in T._removeData(t, "fxshow"), d) T.style(t, e, d[e]) }), d) a = ct(p ? h[i] : 0, i, u), i in h || (h[i] = a.start, p && (a.end = a.start, a.start = "width" === i || "height" === i ? 1 : 0))
            }],
            at = {
                "*": [function(e, t) {
        ...
        function st() { return setTimeout(function() { Je = void 0 }), Je = T.now() }
        ...
        function ut(o, e, t) {
            var n, a, i = 0,
                ...
                l = function() { if (a) return !1; for (var e = Je || st(), t = Math.max(0, c.startTime + c.duration - e), n = 1 - (t / c.duration || 0), i = 0, r = c.tweens.length; i < r; i++) c.tweens[i].run(n); return s.notifyWith(o, [c, n, t]), n < 1 && r ? t : (s.resolveWith(o, [c]), !1) },
                c = s.promise({
                    elem: o,
                    props: T.extend({}, e),
                    ...
                    duration: t.duration,
                    tweens: [],
                    createTween: function(e, t) { var n = T.Tween(o, c.opts, e, t, c.opts.specialEasing[e] || c.opts.easing); return c.tweens.push(n), n },
                    stop: function(e) {
                        var t = 0,
            ...
            return T.map(u, ct, c), T.isFunction(c.opts.start) && c.opts.start.call(o, c), T.fx.timer(T.extend(l, { elem: o, anim: c, queue: c.opts.queue })), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always)
        }
        T.Animation = T.extend(ut, { tweener: function(e, t) { for (var n, i = 0, r = (e = T.isFunction(e) ? (t = e, ["*"]) : e.split(" ")).length; i < r; i++) n = e[i], at[n] = at[n] || [], at[n].unshift(t) }, prefilter: function(e, t) { t ? ot.unshift(e) : ot.push(e) } }), T.speed = function(e, t, n) { var i = e && "object" == typeof e ? T.extend({}, e) : { complete: n || !n && t || T.isFunction(e) && e, duration: e, easing: n && t || t && !T.isFunction(t) && t }; return i.duration = T.fx.off ? 0 : "number" == typeof i.duration ? i.duration : i.duration in T.fx.speeds ? T.fx.speeds[i.duration] : T.fx.speeds._default, null != i.queue && !0 !== i.queue || (i.queue = "fx"), i.old = i.complete, i.complete = function() { T.isFunction(i.old) && i.old.call(this), i.queue && T.dequeue(this, i.queue) }, i }, T.fn.extend({
            fadeTo: function(e, t, n, i) { return this.filter(I).css("opacity", 0).show().end().animate({ opacity: t }, e, n, i) },
            ...
            var r = T.fn[i];
            T.fn[i] = function(e, t, n) { return null == e || "boolean" == typeof e ? r.apply(this, arguments) : this.animate(lt(i, !0), e, t, n) }
        }), T.each({ slideDown: lt("show"), slideUp: lt("hide"), slideToggle: lt("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function(e, i) { T.fn[e] = function(e, t, n) { return this.animate(i, e, t, n) } }), T.timers = [], T.fx.tick = function() {
            var e, t = T.timers,
                n = 0;
            for (Je = T.now(); n < t.length; n++)(e = t[n])() || t[n] !== e || t.splice(n--, 1);
            t.length || T.fx.stop(), Je = void 0
        }, T.fx.timer = function(e) { T.timers.push(e), e() ? T.fx.start() : T.timers.pop() }, T.fx.interval = 13, T.fx.start = function() { Qe || (Qe = setInterval(T.fx.tick, T.fx.interval)) }, T.fx.stop = function() { clearInterval(Qe), Qe = null }, T.fx.speeds = { slow: 600, fast: 200, _default: 400 }, T.fn.delay = function(i, e) {
            return i = T.fx && T.fx.speeds[i] || i, e = e || "fx", this.queue(e, function(e, t) {
                var n = setTimeout(e, i);
                t.stop = function() { clearTimeout(n) }
            })
        ...
        T.fn.extend({
            val: function(n) {
                ...
                return arguments.length ? (r = T.isFunction(n), this.each(function(e) {
                    var t;
                    1 === this.nodeType && (null == (t = r ? n.call(this, e, T(this).val()) : n) ? t = "" : "number" == typeof t ? t += "" : T.isArray(t) && (t = T.map(t, function(e) { return null == e ? "" : e + "" })), (i = T.valHooks[this.type] || T.valHooks[this.nodeName.toLowerCase()]) && "set" in i && void 0 !== i.set(this, t, "value") || (this.value = t))
            ...
            valHooks: {
                option: { get: function(e) { var t = T.find.attr(e, "value"); return null != t ? t : T.trim(T.text(e)) } },
                select: {
                    get: function(e) {
        ...
        }), T.each(["radio", "checkbox"], function() { T.valHooks[this] = { set: function(e, t) { if (T.isArray(t)) return e.checked = 0 <= T.inArray(T(e).val(), t) } }, v.checkOn || (T.valHooks[this].get = function(e) { return null === e.getAttribute("value") ? "on" : e.value }) });
        var ft, pt, ht = T.expr.attrHandle,
            mt = /^(?:checked|selected)$/i,
            gt = v.getSetAttribute,
            vt = v.input;
        T.fn.extend({ attr: function(e, t) { return z(this, T.attr, e, t, 1 < arguments.length) }, removeAttr: function(e) { return this.each(function() { T.removeAttr(this, e) }) } }), T.extend({
            ...
            attrHooks: { type: { set: function(e, t) { if (!v.radioValue && "radio" === t && T.nodeName(e, "input")) { var n = e.value; return e.setAttribute("type", t), n && (e.value = n), t } } } }
        }), pt = { set: function(e, t, n) { return !1 === t ? T.removeAttr(e, n) : vt && gt || !mt.test(n) ? e.setAttribute(!gt && T.propFix[n] || n, n) : e[T.camelCase("default-" + n)] = e[n] = !0, n } }, T.each(T.expr.match.bool.source.match(/\w+/g), function(e, t) {
            var o = ht[t] || T.find.attr;
            ht[t] = vt && gt || !mt.test(t) ? function(e, t, n) { var i, r; return n || (r = ht[t], ht[t] = i, i = null != o(e, t, n) ? t.toLowerCase() : null, ht[t] = r), i } : function(e, t, n) { if (!n) return e[T.camelCase("default-" + t)] ? t.toLowerCase() : null }
        }), vt && gt || (T.attrHooks.value = {
            set: function(e, t, n) {
                if (!T.nodeName(e, "input")) return ft && ft.set(e, t, n);
                e.defaultValue = t
            }
        }), gt || (ft = { set: function(e, t, n) { var i = e.getAttributeNode(n); if (i || e.setAttributeNode(i = e.ownerDocument.createAttribute(n)), i.value = t += "", "value" === n || t === e.getAttribute(n)) return t } }, ht.id = ht.name = ht.coords = function(e, t, n) { var i; if (!n) return (i = e.getAttributeNode(t)) && "" !== i.value ? i.value : null }, T.valHooks.button = { get: function(e, t) { var n = e.getAttributeNode(t); if (n && n.specified) return n.value }, set: ft.set }, T.attrHooks.contenteditable = { set: function(e, t, n) { ft.set(e, "" !== t && t, n) } }, T.each(["width", "height"], function(e, n) { T.attrHooks[n] = { set: function(e, t) { if ("" === t) return e.setAttribute(n, "auto"), t } } })), v.style || (T.attrHooks.style = { get: function(e) { return e.style.cssText || void 0 }, set: function(e, t) { return e.style.cssText = t + "" } });
        ...
        T.fn.extend({
            addClass: function(t) {
                var e, n, i, r, o, a, s = 0,
                    l = this.length,
                    c = "string" == typeof t && t;
                if (T.isFunction(t)) return this.each(function(e) { T(this).addClass(t.call(this, e, this.className)) });
                if (c)
            ...
            removeClass: function(t) {
                ...
                if (T.isFunction(t)) return this.each(function(e) { T(this).removeClass(t.call(this, e, this.className)) });
                if (c)
                    for (e = (t || "").match(q) || []; s < l; s++)
                        if (i = 1 === (n = this[s]).nodeType && (n.className ? (" " + n.className + " ").replace(wt, " ") : "")) {
                            for (o = 0; r = e[o++];)
            ...
            toggleClass: function(r, t) {
                var o = typeof r;
                return "boolean" == typeof t && "string" === o ? t ? this.addClass(r) : this.removeClass(r) : T.isFunction(r) ? this.each(function(e) { T(this).toggleClass(r.call(this, e, this.className, t), t) }) : this.each(function() {
                    if ("string" === o)
        ...
        T.parseJSON = function(e) {
            ...
            var r, o = null,
                t = T.trim(e + "");
            return t && !T.trim(t.replace(Tt, function(e, t, n, i) { return r && t && (o = 0), 0 === o ? e : (r = n || t, o += !i - !n, "") })) ? Function("return " + t)() : T.error("Invalid JSON: " + e)
        }, T.parseXML = function(e) { var t; if (!e || "string" != typeof e) return null; try { h.DOMParser ? t = (new DOMParser).parseFromString(e, "text/xml") : ((t = new ActiveXObject("Microsoft.XMLDOM")).async = "false", t.loadXML(e)) } catch (e) { t = void 0 } return t && t.documentElement && !t.getElementsByTagName("parsererror").length || T.error("Invalid XML: " + e), t };
        var Et, kt, _t = /#.*$/,
            jt = /([?&])_=[^&]*/,
            St = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
            qt = /^(?:GET|HEAD)$/,
        ...
        function Ot(t, r, o, a) {
            ...
            function c(e) { var i; return s[e] = !0, T.each(t[e] || [], function(e, t) { var n = t(r, o, a); return "string" != typeof n || l || s[n] ? l ? !(i = n) : void 0 : (r.dataTypes.unshift(n), c(n), !1) }), i }
            return c(r.dataTypes[0]) || !s["*"] && c("*")
        }

        function Mt(e, t) { var n, i, r = T.ajaxSettings.flatOptions || {}; for (i in t) void 0 !== t[i] && ((r[i] ? e : n || (n = {}))[i] = t[i]); return n && T.extend(!0, e, n), e }
        Et = At.exec(kt.toLowerCase()) || [], T.extend({
            active: 0,
            lastModified: {},
            etag: {},
            ajaxSettings: { url: kt, type: "GET", isLocal: /^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(Et[1]), global: !0, processData: !0, async: !0, contentType: "application/x-www-form-urlencoded; charset=UTF-8", accepts: { "*": Pt, text: "text/plain", html: "text/html", xml: "application/xml, text/xml", json: "application/json, text/javascript" }, contents: { xml: /xml/, html: /html/, json: /json/ }, responseFields: { xml: "responseXML", text: "responseText", json: "responseJSON" }, converters: { "* text": String, "text html": !0, "text json": T.parseJSON, "text xml": T.parseXML }, flatOptions: { url: !0, context: !0 } },
            ajaxSetup: function(e, t) { return t ? Mt(Mt(e, T.ajaxSettings), t) : Mt(T.ajaxSettings, e) },
            ajaxPrefilter: Lt($t),
            ajaxTransport: Lt(Dt),
            ajax: function(e, t) {
                ...
                var n, i, u, d, f, p, h, r, m = T.ajaxSetup({}, t),
                    ...
                    C = {
                        ...
                        getAllResponseHeaders: function() { return 2 === x ? d : null },
                        setRequestHeader: function(e, t) { var n = e.toLowerCase(); return x || (e = a[n] = a[n] || e, o[e] = t), this },
                        overrideMimeType: function(e) { return x || (m.mimeType = e), this },
                        ...
                        abort: function(e) { var t = e || s; return h && h.abort(t), l(0, t), this }
                    };
                ...
                if (h = Ot(Dt, m, t, C)) {
                    C.readyState = 1, p && v.trigger("ajaxSend", [C, m]), m.async && 0 < m.timeout && (f = setTimeout(function() { C.abort("timeout") }, m.timeout));
                    try { x = 1, h.send(o, l) } catch (e) {
                        if (!(x < 2)) throw e;
                        l(-1, e)
                    }
        ...
        }), T.each(["get", "post"], function(e, r) { T[r] = function(e, t, n, i) { return T.isFunction(t) && (i = i || n, n = t, t = void 0), T.ajax({ url: e, type: r, dataType: i, data: t, success: n }) } }), T.each(["ajaxStart", "ajaxStop", "ajaxComplete", "ajaxError", "ajaxSuccess", "ajaxSend"], function(e, t) { T.fn[t] = function(e) { return this.on(t, e) } }), T._evalUrl = function(e) { return T.ajax({ url: e, type: "GET", dataType: "script", async: !1, global: !1, throws: !0 }) }, T.fn.extend({
            wrapAll: function(t) {
                if (T.isFunction(t)) return this.each(function(e) { T(this).wrapAll(t.call(this, e)) });
                if (this[0]) {
                    var e = T(t, this[0].ownerDocument).eq(0).clone(!0);
                    this[0].parentNode && e.insertBefore(this[0]), e.map(function() { for (var e = this; e.firstChild && 1 === e.firstChild.nodeType;) e = e.firstChild; return e }).append(this)
                }
                return this
            },
            wrapInner: function(n) {
                return T.isFunction(n) ? this.each(function(e) { T(this).wrapInner(n.call(this, e)) }) : this.each(function() {
                    var e = T(this),
                        t = e.contents();
                    t.length ? t.wrapAll(n) : e.append(n)
                })
            },
            wrap: function(t) { var n = T.isFunction(t); return this.each(function(e) { T(this).wrapAll(n ? t.call(this, e) : t) }) },
            unwrap: function() { return this.parent().each(function() { T.nodeName(this, "body") || T(this).replaceWith(this.childNodes) }).end() }
        }), T.expr.filters.hidden = function(e) { return e.offsetWidth <= 0 && e.offsetHeight <= 0 || !v.reliableHiddenOffsets() && "none" === (e.style && e.style.display || T.css(e, "display")) }, T.expr.filters.visible = function(e) { return !T.expr.filters.hidden(e) };
        var Ht = /%20/g,
            Ft = /\[\]$/,
            Rt = /\r?\n/g,
        ...
        function It(n, e, i, r) {
            var t;
            if (T.isArray(e)) T.each(e, function(e, t) { i || Ft.test(n) ? r(n, t) : It(n + "[" + ("object" == typeof t ? e : "") + "]", t, i, r) });
        ...
        T.param = function(e, t) {
            var n, i = [],
                r = function(e, t) { t = T.isFunction(t) ? t() : null == t ? "" : t, i[i.length] = encodeURIComponent(e) + "=" + encodeURIComponent(t) };
            if (void 0 === t && (t = T.ajaxSettings && T.ajaxSettings.traditional), T.isArray(e) || e.jquery && !T.isPlainObject(e)) T.each(e, function() { r(this.name, this.value) });
            else
                for (n in e) It(n, e[n], t, r);
            return i.join("&").replace(Ht, "+")
        }, T.fn.extend({ serialize: function() { return T.param(this.serializeArray()) }, serializeArray: function() { return this.map(function() { var e = T.prop(this, "elements"); return e ? T.makeArray(e) : this }).filter(function() { var e = this.type; return this.name && !T(this).is(":disabled") && Wt.test(this.nodeName) && !Bt.test(e) && (this.checked || !U.test(e)) }).map(function(e, t) { var n = T(this).val(); return null == n ? null : T.isArray(n) ? T.map(n, function(e) { return { name: t.name, value: e.replace(Rt, "\r\n") } }) : { name: t.name, value: n.replace(Rt, "\r\n") } }).get() } }), T.ajaxSettings.xhr = void 0 !== h.ActiveXObject ? function() { return !this.isLocal && /^(get|post|head|put|delete|options)$/i.test(this.type) && Gt() || function() { try { return new h.ActiveXObject("Microsoft.XMLHTTP") } catch (e) {} }() } : Gt;
        var zt = 0,
            Ut = {},
            Xt = T.ajaxSettings.xhr();

        function Gt() { try { return new h.XMLHttpRequest } catch (e) {} }
        h.ActiveXObject && T(h).on("unload", function() { for (var e in Ut) Ut[e](void 0, !0) }), v.cors = !!Xt && "withCredentials" in Xt, (Xt = v.ajax = !!Xt) && T.ajaxTransport(function(l) {
            var c;
        ...
        }), T.ajaxSetup({ accepts: { script: "text/javascript, application/javascript, application/ecmascript, application/x-ecmascript" }, contents: { script: /(?:java|ecma)script/ }, converters: { "text script": function(e) { return T.globalEval(e), e } } }), T.ajaxPrefilter("script", function(e) { void 0 === e.cache && (e.cache = !1), e.crossDomain && (e.type = "GET", e.global = !1) }), T.ajaxTransport("script", function(t) {
            if (t.crossDomain) {
        ...
        T.fn.load = function(e, t, n) {
            ...
            var i, r, o, a = this,
                s = e.indexOf(" ");
            return 0 <= s && (i = T.trim(e.slice(s, e.length)), e = e.slice(0, s)), T.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (o = "POST"), 0 < a.length && T.ajax({ url: e, type: o, dataType: "html", data: t }).done(function(e) { r = arguments, a.html(i ? T("<div>").append(T.parseHTML(e)).find(i) : e) }).complete(n && function(e, t) { a.each(n, r || [e.responseText, t, e]) }), this
        }, T.expr.filters.animated = function(t) { return T.grep(T.timers, function(e) { return t === e.elem }).length };
        ...
        T.offset = {
            ...
            offset: function(t) {
                if (arguments.length) return void 0 === t ? this : this.each(function(e) { T.offset.setOffset(this, t, e) });
                var e, n, i = { top: 0, left: 0 },
                    r = this[0],
                    o = r && r.ownerDocument;
                return o ? (e = o.documentElement, T.contains(e, r) ? (typeof r.getBoundingClientRect !== P && (i = r.getBoundingClientRect()), n = Kt(o), { top: i.top + (n.pageYOffset || e.scrollTop) - (e.clientTop || 0), left: i.left + (n.pageXOffset || e.scrollLeft) - (e.clientLeft || 0) }) : i) : void 0
            },
            position: function() {
                if (this[0]) {
                    var e, t, n = { top: 0, left: 0 },
                        i = this[0];
                    return "fixed" === T.css(i, "position") ? t = i.getBoundingClientRect() : (e = this.offsetParent(), t = this.offset(), T.nodeName(e[0], "html") || (n = e.offset()), n.top += T.css(e[0], "borderTopWidth", !0), n.left += T.css(e[0], "borderLeftWidth", !0)), { top: t.top - n.top - T.css(i, "marginTop", !0), left: t.left - n.left - T.css(i, "marginLeft", !0) }
                }
            },
            offsetParent: function() { return this.map(function() { for (var e = this.offsetParent || Yt; e && !T.nodeName(e, "html") && "static" === T.css(e, "position");) e = e.offsetParent; return e || Yt }) }
        ...
        }), T.each(["top", "left"], function(e, n) { T.cssHooks[n] = Pe(v.pixelPosition, function(e, t) { if (t) return t = Ne(e, n), $e.test(t) ? T(e).position()[n] + "px" : t }) }), T.each({ Height: "height", Width: "width" }, function(o, a) {
            T.each({ padding: "inner" + o, content: a, "": "outer" + o }, function(i, e) {
                T.fn[e] = function(e, t) {
                    var n = arguments.length && (i || "boolean" != typeof e),
                        r = i || (!0 === e || !0 === t ? "margin" : "border");
                    return z(this, function(e, t, n) { var i; return T.isWindow(e) ? e.document.documentElement["client" + o] : 9 === e.nodeType ? (i = e.documentElement, Math.max(e.body["scroll" + o], i["scroll" + o], e.body["offset" + o], i["offset" + o], i["client" + o])) : void 0 === n ? T.css(e, t, r) : T.style(e, t, n, r) }, a, n ? e : void 0, n, null)
                }
            })
        }), T.fn.size = function() { return this.length }, T.fn.andSelf = T.fn.addBack, "function" == typeof define && define.zqamd && define("jquery", [], function() { return T });
        var Zt = h.jQuery,
            en = h.$;
        return T.noConflict = function(e) { return h.$ === T && (h.$ = en), e && h.jQuery === T && (h.jQuery = Zt), T }, typeof e === P && (h.jQuery = h.$ = T), T
    }), $(function() { window.crosswiseMalposition && window.crosswiseMalposition(), $(".main").find(".w_sfbox-001 .p_wrapbox").show(), writeBFP() }), $(window).load(function() { window.pageLoad = !0 }), isFrontEnv() && $(window).load(function() {
        ...
        require([e + "md.yun300.cn/set-sail-sdk/pc/jquery.md5.js"], function(e) { require([t], function(e) { require([n], function(e) {}) }) })
    }), isFrontEnv() && $(window).load(function() {
        var e = window.globalObj.isOpenSSL ? "https://" : "http://",
            t = e + "md.yun300.cn/set-sail-sdk/pc/clickstream.js",
            n = e + "md.yun300.cn/set-sail-sdk/pc/streamCollect.js";
        require([e + "md.yun300.cn/set-sail-sdk/pc/jquery.md5.js"], function(e) { require([t], function(e) { require([n], function(e) {}) }) })
    }), function() { var e = (navigator.browserLanguage || navigator.language).toLowerCase(); try { if (1 <= foreignList.length && !getParentWindow().VisualManager && !sendLevel.test(window.location.hostname)) { var t = e.substring(0, 2); "zh" == t && (t = "zh-cn" == e || "zh_cn" == e ? "zh_CN" : "zh_HN") } } catch (e) {} }(), null == getCookie(noredirectCookieName) && !getParentWindow().VisualManager && (window.userAgent = navigator.userAgent, window.mobileAgentReg = /(.*Android|.*iPhone|.*X11.{1}.*Linux*)/, mobileAgentReg.test(userAgent) && 6 == tenant.mobileStatus)) {
    var path = window.location.pathname,
        mobileTarget = getSettingMobileUrl();
    try { null != mobileTarget || "/" != path || null == tenant.mobileDomain || 8 == tenant.mobileStatus && 9 == tenant.mobileStatus || sendLevel.test(window.location.hostname) || (mobileTarget = window.globalObj.getProtocol() + tenant.mobileDomain) } catch (e) {}
    null != mobileTarget && mobileFoward(mobileTarget)
}
"100001" == window.tenant.unittype && (11 != tenant.status || getCookie("_nofirst") || (setCookie("_nofirst", "true"), window.location.href = "/toUpgradeOnline.jsp"), 7 == tenant.status && (window.location.href = "/pauseing.jsp")), window.compLoaded = !1, window.needRestCurrentComp = {}, window.addResetCompListener = function(e) { $("#" + e).attr("comreset", "false"), needRestCurrentComp[e] = !0 };
try {
    ...
    function adjustInnerHeight(e) {
        if (compLoaded) {
            ...
            if ("true" != t.attr("comreset")) {
                ...
                n.removeClass("actives"), n.each(function(e, t) { $(t).parent().hasClass("active") ? ($(t).parent().css("height", t.scrollHeight), $(t).css("height", t.scrollHeight), $(t).addClass("actives"), $(t).parent().trigger("FR_CHANGECOMPHEIGHT")) : $(t).parent().hasClass("p_box003") || $(t).parent().css("height", "0") }), t.attr("comreset")
            }
        }
    }
    $(function() {
...
function openNoPerDialog() { require(["jquery.dialogMgr"], function() { window.$.dialogMgr.create({ url: "/public/html/auth/no_oper-dialog.html" }) }) }! function() {
    var e, t = !1,
        n = !($.isFlowStyle = function() { return !1 === t && (e = $("body").attr("data-layout"), t = !0), "flow_noResponsive" == e });
    $.isAbsStyle = function() { return !1 === n && (absLayout = $("body").attr("data-layout"), n = !0), void 0 === absLayout }
}(), $(function() {
    ...
    function c() { isFrontEnv() || window.siteIsPc ? window.outerWidth == $(window).width() && $("div[id^=w_sfbox-]").width(window.outerWidth).filter(function() { return "fixed" != $(this).css("position") }).css("left", -$(".pagebox").offset().left) : $("div[id^=w_sfbox-]").width(640).filter(function() { return "fixed" != $(this).css("position") }).css("left", 0) }

    function u() {
        if (window.siteIsPc) {
            var e = $("div[id^=w_sfbox-]").width() ? window.innerWidth : $(window).width();
            $("div[id^=w_wbox-],div[id^=w_cbox-],div[id^=w_bbox-],div[id^=w_fbox-]").width(e).filter(function() { return "fixed" != $(this).css("position") }).css("left", -$(".pagebox").offset().left)
        }
    }
    $("div[id^=w_fbox-]").length && (s = !0), $("div[id^=w_sfbox-]").length && (s = !0),
        ...
        }(), $(window).on("resize.fullPageResize", function() { u(), c() }), $("[id^=w_relationbtntab-]").each(function(e, t) {
        ...
        }).on("mouseenter", ".w_relationbtntab>.p_box001>.e_link", function(e) { $(this).parent().attr("data-mouseovertoggle") && $(this).trigger("click") }), $("body").on("mouseover", '.w_relationbtntab>.p_box001[data-mouseovertoggle="true"]>.e_link', function(e) {
            var t = $t = $(this),
                n = $(this).closest(".w_relationbtntab"),
                i = n.find(">.p_box001>.e_link"),
                r = n.find(">.p_box002>.e_box");
